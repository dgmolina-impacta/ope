...
class Os(db.Model):
    ...
    problema_constatado = db.Column(db.String(500), nullable=True)
    problema_informado = db.Column(db.String(500), nullable=False)
    status = db.Column(db.String(20), nullable=False)
    tipo_defeito = db.Column(db.String(100), nullable=False)
